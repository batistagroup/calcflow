...
def setup_logging() -> None:
    ...
    'CALCFLOW_LOG_LEVEL' environment variable. If the environment
    ...
    # 1. Check for CALCFLOW_LOG_LEVEL environment variable.
    # 2. Default to 'INFO' if not set or invalid.
    log_level_env = os.getenv("CALCFLOW_LOG_LEVEL", "INFO").upper()
...
# Get the logger for the 'calcflow' application.
